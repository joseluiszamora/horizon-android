...
public class MainActivity extends Activity {
	...
	private class CheckIfExistWebAsyncDialog extends AsyncTask<Void, Integer, String> {
    	...
    	protected String doInBackground(Void... params) {    		
    		...
    		String returnJson = jsonParser.makeHttpRequest("http://www.mariani.bo/horizonscz/index.php/webservice/check_if_user", "POST", paramsTransaction);
    		...
    		//String returnJson = jsonParser.makeHttpRequest("http://www.mariani.bo/horizonscz/webservice/check_if_user", "POST", paramsTransaction);
...
//        	get passed value
    		...
    		// getting JSON string from URL
    		String jsonProducts = jsonParser.makeHttpRequest("http://www.mariani.bo/horizonscz/index.php/webservice/check_user_mail", "GET", paramsVerifyMail);
    		...
    		//String jsonProducts = jsonParser.makeHttpRequest("http://www.mariani.bo/horizonscz/webservice/check_user_mail", "GET", paramsVerifyMail);

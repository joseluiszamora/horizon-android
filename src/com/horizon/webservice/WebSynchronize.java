...
// 	Products JSONArray
	...
	public void updateProducts(DatabaseHandlerProducts databaseProducts){					
		...
		String jsonProducts = jsonParser.makeHttpRequest("http://www.mariani.bo/horizonscz/product/report_android", "GET", params);
	...
	public void updateClients(DatabaseHandlerCustomers dbCustomers) {
		...
		// getting JSON string from URL
		String json = jsonParser.makeHttpRequest("http://www.mariani.bo/horizonscz/client/report_android", "GET",
				params);

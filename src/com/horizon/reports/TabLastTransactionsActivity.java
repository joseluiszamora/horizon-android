...
public class TabLastTransactionsActivity extends Activity implements OnItemClickListener {
	...
	// Select Dialog Create Interface
	    	    ...
	    	    public void onClick(DialogInterface dialog, int item) {
					...
					if (item == 1) {
				        ...
				        if (!internet.isConnectingToInternet()) {
				        	// message
							Toast toast = Toast.makeText(TabLastTransactionsActivity.this, "No hay conexión a Internet", Toast.LENGTH_SHORT);
			    			toast.show();		         
				        }else{
	    ...
	    private void deleteTransaction(final String id_customer){
	    	AlertDialog.Builder builder = new AlertDialog.Builder(this);
	        builder.setMessage("¿Está seguro de eliminar esta Transacción? ")
...
/** MENU **/
		...
		private class SaveTransactionDialog extends AsyncTask<Void, Integer, Boolean> {
	    	...
	    	protected Boolean doInBackground(Void... params) {
	    		...
	    		//String returnJson = jsonParser.makeHttpRequest("http://www.mariani.bo/horizon-sc/webservice/save_transaction", "POST", paramsTransaction);

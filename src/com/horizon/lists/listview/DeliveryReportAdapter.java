...
public class DeliveryReportAdapter extends BaseAdapter {
    ...
    public DeliveryReportAdapter(Context context, List<Transaction> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.transactionId.setText("" + rowItem.getID());
        holder.txtClient.setText(customer.getName());
        holder.txtAddress.setText(customer.getAddress());
        holder.txtDateStart.setText(rowItem.getTimeStart());        
        holder.txtCoordinate.setText("Estado de la Transaccion: " + rowItem.getStatus());
